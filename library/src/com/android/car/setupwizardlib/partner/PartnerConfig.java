...
public enum PartnerConfig {
    ...
    CONFIG_TOOLBAR_BUTTON_ICON_NEXT(
            PartnerConfigKey.KEY_TOOLBAR_BUTTON_ICON_NEXT, ResourceType.DRAWABLE),

    CONFIG_TOOLBAR_BUTTON_ICON_SKIP(
            PartnerConfigKey.KEY_TOOLBAR_BUTTON_ICON_SKIP, ResourceType.DRAWABLE),

    CONFIG_TOOLBAR_BUTTON_FONT_FAMILY(
            PartnerConfigKey.KEY_TOOLBAR_BUTTON_FONT_FAMILY, ResourceType.STRING),

    CONFIG_TOOLBAR_BUTTON_PADDING_BOTTOM(
            PartnerConfigKey.KEY_TOOLBAR_BUTTON_PADDING_BOTTOM, ResourceType.DIMENSION),

    CONFIG_TOOLBAR_BUTTON_PADDING_TOP(
            PartnerConfigKey.KEY_TOOLBAR_BUTTON_PADDING_TOP, ResourceType.DIMENSION),
    ...
    CONFIG_TOOLBAR_LAYOUT_BG_COLOR(
            PartnerConfigKey.KEY_TOOLBAR_LAYOUT_BG_COLOR, ResourceType.COLOR);
